...
$html .= '
    <center>
    <h3>
    <b>REKAP KASUS TAHUN :  ' . $searchModel->tahun . '</b>
    </h3>
    </center>
    <br>
    ';
    ...
    <table width = 100% border = "1">
        <thead>
            <tr>
                <th>No.</th>
                <th>No. Reg</th>
                <th>Tanggal Laporan &amp; Kejadian</th>
                <th>Korban</th>
                <th>Pelaku</th>
                <th>Ket. Kasus</th>
            </tr>
...
foreach ($rekap as $row) {
    ...
    <tr>
        ...
        <td> Bulan: ' . strtoupper($bulanindo) . '<br>Kejadian: ' . $kejadian . '<br>Pelaporan: ' . $pelaporan . '</td>
        <td>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RekapKasusTahunan' . $searchModel->tahun . '.pdf', 'I');
