...
?>
<?php echo $this->render('_search_bulanan', ['model' => $searchModel]); ?>
...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th>Tang gal Lapor dan Kejadian</th>
            <th>Korban</th>
            <th>Pelaku</th>
            <th>Status Kasus</th>
        </tr>
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    echo 'Status Kasus: ' . $e_status . '<br> Pelayanan yang diberikan: <b>' . $layanan . '</b><br> Deskripsi Layanan: <b>' . $deskrip_layanan . '</b>';
                    ?>
                </td>
            </tr>
        <?php } ?>
